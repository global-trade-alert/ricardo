  ...
  output$leadsTable <- DT::renderDataTable(DT::datatable(
    ...
    options = list(
      ...
      rowCallback = JS("function ( row, data ) {
                            ...
                            var right = '<div class=\\'right-col\\'><div id=\\'no-policy-mentioned\\' class=\\'evaluate discard-reason\\'><span>No policy<br/>mentioned</span></div><div id=\\'not-commercial-policy\\' class=\\'evaluate discard-reason\\'><span>Not commercial<br/>policy</span></div><div id=\\'update-to-existing\\' class=\\'evaluate discard-reason\\'><span>Update to<br/>existing</span></div><div id=\\'duplicate-of-existing\\' class=\\'evaluate discard-reason\\'><span>Duplicate of<br/>existing</span></div><div id=\\'discard\\' class=\\'evaluate\\'><span class=\\'material-icons\\'>cancel</span></div><div id=\\'relevant\\' class=\\'evaluate\\'><span class=\\'material-icons\\'>check_circle</span></div></div>';
                           $(row)
