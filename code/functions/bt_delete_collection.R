bt_delete_collection=function(collection.id=NULL){
  ...
  del.statement = sprintf(paste0("DELETE b221_collection_assessment, b221_collection_date, b221_collection_intervention, b221_collection_jurisdiction, b221_collection_product_group, b221_collection_relevance, b221_collection_star, b221_hint_collection, b221_collection_log 
