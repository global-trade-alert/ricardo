bt_export_main_db=function(to.db = 'ricardodev', is.superuser = NULL, user.id = NULL, force.flush = NULL, soft.flush = NULL){
  ...
  populate.sql.query = paste0("/* SCRIPT TO UPDATE RICARDO DB AND LOCATE CONFLICTS */
                              ...
                              DELETE bt_hint_documentation_status FROM bt_hint_documentation_status WHERE EXISTS (SELECT NULL FROM bt_base_export WHERE bt_base_export.hint_id = bt_hint_documentation_status.hint_id);
                              
                              INSERT INTO bt_hint_documentation_status(hint_id, documentation_status_id)
                              ...
                              SELECT DISTINCT bt_base_export.hint_id, bt_base_export.title, bt_base_export.description, 1 AS language_id, @classification_id AS classification_id, 1 AS description_accepted, @classification_id AS validation_classification, 0 AS confirm_status
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT @conflict_id AS conflict_id, bt_base_export.hint_id, bt_base_export.title AS conflict_title, bt_base_export.description AS conflict_description, 1 AS conflict_status, NULL AS resolution_classification
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT bt_base_export.hint_id, @classification_id AS classification_id, IF(bt_base_export.status_id = 5, 0, 1) AS relevance, NULL AS relevance_probability, 1 AS relevance_accepted, @classification_id AS validation_classification, 0 AS confirm_status 
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT @conflict_id AS conflict_id, bt_base_export.hint_id, IF(bt_base_export.status_id = 5, 0, 1) AS relevance, 1 AS conflict_status, NULL AS resolution_classification
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT bt_base_export.hint_id, @classification_id AS classification_id, b221_assessment_list.assessment_id, 1 AS assessment_accepted, @classification_id AS validation_classification, 0 AS confirm_status 
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT @conflict_id AS conflict_id, bt_base_export.hint_id, b221_assessment_list.assessment_id AS conflict_assessment_id, 1 AS conflict_status, NULL AS resolution_classification
                              FROM bt_base_export
                              JOIN b221_assessment_list ON bt_base_export.evaluation_id = b221_assessment_list.gta_assessment_id
                              ...
                              SELECT DISTINCT bt_base_export.hint_id, @classification_id AS classification_id, gta_jurisdiction_list.jurisdiction_id, 1 AS jurisdiction_accepted, @classification_id AS validation_classification, 0 AS confirm_status
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT @conflict_id AS conflict_id, bt_base_export.hint_id, gta_jurisdiction_list.jurisdiction_id AS conflict_jurisdiction_id, 1 AS conflict_status, NULL AS resolution_classification
                              FROM bt_base_export 
                              ...
                              SELECT DISTINCT bt_base_export.hint_id, @classification_id AS classification_id, b221_product_group_list.product_group_id AS product_group_id, 1 AS product_group_assessment, @classification_id AS validation_classification, 0 AS confirm_status
                              ...
                              SELECT DISTINCT @conflict_id AS conflict_id, new_prod.hint_id, b221_product_group_list.product_group_id AS conflict_product_group_id, 1 AS conflict_status, NULL AS resolution_classification
                              FROM bt_product_export 
                              ...
                              SELECT DISTINCT bt_base_export.hint_id, @classification_id AS classification_id, b221_intervention_type_list.intervention_type_id, 1 AS intervention_accepted, @classification_id AS validation_classification, 0 AS confirm_status
                              FROM bt_base_export
                              ...
                              SELECT DISTINCT @conflict_id AS conflict_id, bt_base_export.hint_id, b221_intervention_type_list.intervention_type_id AS conflict_intervention_id, 1 AS conflict_status, NULL AS resolution_classification
                              FROM bt_base_export 
                              ...
                              SELECT base_urls.hint_id, bt_url_log.url_id, base_urls.url_type_id, @classification_id AS classification_id, 1 AS url_accepted, @classification_id AS validation_classification, 0 AS confirm_status FROM 
                              ...
                              INSERT INTO bt_conflict_url(conflict_id, hint_id, conflict_url_id, conflict_url_type_id, conflict_status, resolution_classification)
                              SELECT DISTINCT @conflict_id AS conflict_id, base_urls.hint_id, bt_url_log.url_id, base_urls.url_type_id, 1 AS conflict_status, NULL AS resolution_classification
                              ...
                              /* DATE */
                              INSERT INTO bt_hint_date(hint_id, `date`, date_type_id, classification_id, date_accepted, validation_classification, confirm_status)
                              SELECT DISTINCT new_dates.hint_id, `date`, date_type_id, @classification_id AS classification_id, 1 AS date_accepted, @classification_id AS validation_classification, 0 AS confirm_status
                              ...
                              INSERT INTO bt_conflict_date(conflict_id, hint_id, conflict_date, conflict_date_type_id, conflict_status, resolution_classification)
                              SELECT DISTINCT @conflict_id AS conflict_id, long_base_export.hint_id, long_base_export.`date` AS conflict_date, long_base_export.date_type_id, 1 AS conflict_status, NULL AS resolution_classification
                              FROM (SELECT changes.hint_id, @classification_id AS classification_id, (SELECT bt_date_type_list.date_type_id FROM bt_date_type_list WHERE bt_date_type_list.date_type_name = 'implementation') AS date_type_id, changes.inception_date AS `date`, 1 as date_accepted, 1 as validation_user
                              FROM bt_base_export changes
                              UNION 
                              SELECT changes.hint_id, @classification_id AS classification_id, (SELECT bt_date_type_list.date_type_id FROM bt_date_type_list WHERE bt_date_type_list.date_type_name = 'announcement') AS date_type_id, changes.announcement_date AS `date`, 1 as date_accepted, 1 as validation_user
  ...
  if(force.flush == T | soft.flush == T) bt_flush_conflicts(user.id = user.id, is.superuser = is.superuser, force.flush = force.flush, soft.flush = soft.flush)
