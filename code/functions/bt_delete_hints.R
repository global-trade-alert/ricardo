bt_delete_hints=function(del.hint.ids = NULL, db.connection = 'pool'){
  ...
  del.sql.statement = sprintf(paste0("DELETE bt_hint_state_act, b221_hint_assessment, b221_hint_collection, b221_hint_comment_log, b221_hint_intervention, b221_hint_product_group, bt_hint_background_url, bt_hint_bid,
                                  	   bt_hint_evaluation, bt_hint_jurisdiction, bt_hint_lead, bt_hint_processing, bt_hint_relevance, bt_hint_text, bt_hint_url
                                      FROM (",hints.sql,") del_hints
                                      LEFT JOIN bt_hint_state_act ON bt_hint_state_act.hint_id = del_hints.hint_id
                                      LEFT JOIN b221_hint_assessment ON b221_hint_assessment.hint_id = del_hints.hint_id 
                                      ...
                                      LEFT JOIN b221_hint_intervention ON b221_hint_intervention.hint_id = del_hints.hint_id 
                                      LEFT JOIN b221_hint_product_group ON b221_hint_product_group.hint_id = del_hints.hint_id 
                                      ...
                                      LEFT JOIN bt_hint_jurisdiction ON bt_hint_jurisdiction.hint_id = del_hints.hint_id 
                                      ...
                                      LEFT JOIN bt_hint_relevance ON bt_hint_relevance.hint_id = del_hints.hint_id 
                                      LEFT JOIN bt_hint_text ON bt_hint_text.hint_id = del_hints.hint_id
                                      LEFT JOIN bt_hint_url ON bt_hint_url.hint_id = del_hints.hint_id 
                                      WHERE del_hints.hint_id IN (%s);"), paste0(del.hint.ids, collapse = ','))
  
  del.sql.statement.2 = sprintf(paste0("DELETE bt_classification_log, bt_hint_log 
                                       FROM (",hints.sql,") del_hints
